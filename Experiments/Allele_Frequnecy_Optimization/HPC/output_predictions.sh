...
"North_America/Global ../../../data/Proximity_Experiments/HPC/Europe/benchmarks/Connecticut/1" \
...
"Asia/Global ../../../data/Proximity_Experiments/HPC/Asia/benchmarks/Maharashtra/1" ; do \
  set -- $datasets
