...
"USA ../../../data/Proximity_Experiments/North_America/reference_sets/USA/metadata.tsv ../../../data/Proximity_Experiments/North_America/reference_sets/USA/sequences.fasta" \
"North_America ../../../data/Proximity_Experiments/North_America/reference_sets/North_America/metadata.tsv ../../../data/Proximity_Experiments/North_America/reference_sets/North_America/sequences.fasta" \
"Global_next_regions ../../../data/Proximity_Experiments/North_America/reference_sets/Global_next_regions/metadata.tsv ../../../data/Proximity_Experiments/North_America/reference_sets/Global_next_regions/sequences.fasta" ; do \
    #make tuples 
    set -- $reference_set 
